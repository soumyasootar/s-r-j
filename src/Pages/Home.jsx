    ...
    <Box height={"100%"} bgImage={deskimage} style={{
      ...
      >
        ...
        >
          ...
          >
            {" "}
            We Welcome You All To <br/> <span style={{color:"#F96E1E" ,textShadow:"unset"}}>Sarita Resorts.</span>
          </Heading>
          <Text
        ...
        {/* ----------Icon Facility ------------------ */}
        <HStack bg="white" color="black" p={10} borderRadius={"2xl"} mt={"5"}>
          <Flex  bg={"#F96E1E"} borderRadius={"2xl"} p={5} align="center" flexDirection="column" mb={4}>
            {/* <Icon as={FiDollarSign} boxSize={6} color="teal.500" mb={2} /> */}
            <Image src={bestpricerupees} mb={8} w={{ base: "140px", md: "150px",lg:"100px" }}/>
            <Text>
          ...
          <Flex  bg={"#F96E1E"} borderRadius={"2xl"} p={5} align="center" flexDirection="column" mb={4}>
            ...
            <Icon as={FamilyIcon} boxSize={"28"} fill={"black"} mb={9} w={{ base: "140px", md: "150px",lg:"100px" }} />
            <Text>
          ...
          <Flex  bg={"#F96E1E"} borderRadius={"2xl"} p={5} align="center" flexDirection="column" mb={4}>
            ...
            <Image src={amenities} mb={8} w={{ base: "140px", md: "150px",lg:"100px" }}/>
          ...
          <Flex  bg={"#F96E1E"} borderRadius={"2xl"} p={5} align="center" flexDirection="column" mb={4}>
            ...
            <Image src={restaurant} mb={8} w={{ base: "140px", md: "150px",lg:"100px" }}/>
            <Text>
